...
![Dapr secrets building block](./artifacts/media/secrets-overview-azure-aks-keyvault.png)
...
You can run Bash script, [`05-list-secret.sh`](./artifacts/scripts/05-list-secret.sh), to connect to the demo pod and print out the value of the two sample secrets stored in Key Vault.
